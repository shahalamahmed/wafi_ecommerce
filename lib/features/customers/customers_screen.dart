...
import 'package:wafi_ecommerce/features/customers/customers_providers.dart';
...
class _CustomersScreenState extends ConsumerState<CustomersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final asyncCustomers = ref.watch(customerListProvider(tenantId));
    final customers = asyncCustomers.valueOrNull ?? const <CustomerModel>[];
