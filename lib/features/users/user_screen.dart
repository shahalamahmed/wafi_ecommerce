...
class _UsersScreenState extends ConsumerState<UsersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return RoleGuard(
      ...
      fallback: const Center(child: Text('Only admin can manage users')),
      child: Column(
        children: [
          ...
          if (!isMe)
            RoleGuard(
              ...
              child: PopupMenuButton<String>(
                ...
                onSelected: (val) => _handleAction(context, val, uid, role),
                itemBuilder: (_) => [
    ...
    if (['admin', 'manager', 'staff', 'viewer'].contains(action)) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Role updated to $action')));
      }
