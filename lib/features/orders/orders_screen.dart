...
import 'package:wafi_ecommerce/features/orders/orders_providers.dart';
...
class _OrdersScreenState extends ConsumerState<OrdersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final asyncOrders = ref.watch(orderListProvider(tenantId));
    final orders = asyncOrders.valueOrNull ?? const <OrderModel>[];
